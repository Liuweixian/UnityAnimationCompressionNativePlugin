...
struct UnityAnimationCompressionFuncs
{
    ...
    int (*OnCurveCompress)(AnimationCurveForPlugin* allCurves, int curveCount, float startTime, float stopTime, float sampleRate, void* output);
...
int OnCurveCustomCompress(AnimationCurveForPlugin* curve, int curveCount, float startTime, float stopTime, float sampleRate, void* output);
